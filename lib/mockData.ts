...
export const products: Product[] = [
  {
    ...
    description:
      "A relaxed overshirt cut from breathable linen for warm days.",
    isBestSeller: true,
  },

  {
    ...
    variants: [
      ...
      },
      {
        color: "Oat",
        image:
          "https://images.unsplash.com/photo-1506629905607-d9c297d8e6d6?auto=format&fit=crop&w=900&q=80",
      },
    ],
    description:
      "Fluid, tailored trousers designed for work and weekends.",
    isBestSeller: true,
  },

  {
    ...
    description:
      "Lightweight trainers with a cushioned everyday ride.",
    isBestSeller: true,
  },

  {
    ...
    description:
      "A structured tote made for your daily rhythm.",
    isBestSeller: true,
  },

  {
    ...
    description:
      "A dependable field watch with an understated dial.",
    isBestSeller: true,
  },

  {
    ...
    description:
      "A heavyweight cotton staple with a considered fit.",
    isBestSeller: true,
  },

  {
    ...
    description:
      "A softly draped dress that moves with you.",
    isBestSeller: true,
  },

  {
    ...
    description:
      "Clean leather sneakers with timeless court styling.",
  },

  {
    ...
    description:
      "A durable companion for short escapes.",
  },

  {
    ...
    description:
      "A clean everyday timepiece with a leather strap.",
  },

  {
    ...
    description:
      "A practical lightweight jacket with a refined profile.",
  },

  {
    ...
    description:
      "A soft ribbed knit for layering across seasons.",
  },

  {
    ...
    variants: [
      ...
      },
      {
        color: "Sand",
        image:
          "https://images.unsplash.com/photo-1608256246200-53e635f5b65f?auto=format&fit=crop&w=900&q=80",
      },
    ],
    description:
      "Secure, adjustable sandals for city and trail.",
  },

  {
    ...
    description:
      "Hands-free carrying in a compact, intentional shape.",
  },

  {
    id: "solar-watch",
    name: "Solar Everyday Watch",
    category: "Watches",
    price: 169,
    rating: 4.8,
    reviewCount: 61,
    ...
    description:
      "Solar-powered reliability in a versatile silhouette.",
  },
];
