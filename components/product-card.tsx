    ...
    <article className="group relative">
      <div className="relative aspect-[4/5] overflow-hidden rounded-2xl bg-zinc-100">
        ...
        <button
          ...
          className="absolute right-3 top-3 rounded-full bg-white/90 p-2.5 shadow-sm transition hover:scale-105"
      ...
      <div className="pt-4">
        ...
        <div className="mt-1 flex items-start justify-between gap-3">
          <Link
            ...
            className="font-semibold leading-tight text-zinc-900 hover:underline"
          >
            {product.name}
          </Link>
          <span className="whitespace-nowrap font-bold">${product.price}</span>
        </div>
